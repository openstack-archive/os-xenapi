...
def setup_guest_console_log(dom0_client):
    ...
    dom0_client.scp('curl -o /root/rotate_xen_guest_logs.py '
                    'https://raw.githubusercontent.com/openstack/nova/master/'
                    'tools/xenserver/rotate_xen_guest_logs.sh/root/')
