...
# Remove useless folders after buiding RPMs
rm -rf $DOM0_DIR/contrib/rpmbuild/BUILD/
rm -rf $DOM0_DIR/contrib/rpmbuild/RPMS/
rm -rf $DOM0_DIR/contrib/rpmbuild/SOURCES/
rm -rf $DOM0_DIR/contrib/rpmbuild/SRPMS/
