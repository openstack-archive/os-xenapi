...
# This function is used to configure iptables on Dom0 and DomU, input
# arguments:
# client: session client with Dom0
# end_point_list: network interface list which user want to forward HIMN
# packages.
def config_iptables(client, end_point_list):
...
if __name__ == '__main__':
    ...
    config_iptables(client, end_point_list)
