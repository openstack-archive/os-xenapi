...
To ensure it's close to the real VHD file parser, suggest use the data
from a real VHD file for the fake bytes to feed the unit tests.
e.g. Initially the fake data is got from VM's VHD which was booted from
the default devstack image: cirros-0.3.5-x86_64-disk.
"""
