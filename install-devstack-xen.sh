...
JEOS_FILENAME=""
SUPP_PACK_URL=""
UBUNTU_REPO_IP="archive.ubuntu.com"
NODE_TYPE="all"
NODE_NAME=""
CONTROLLER_IP=""
...
# Configure local.conf from sample file
wget https://raw.githubusercontent.com/openstack/os-xenapi/master/devstack/local.conf.sample
...
sed -i "s/UBUNTU_INST_HTTP_HOSTNAME=archive.ubuntu.com/UBUNTU_INST_HTTP_HOSTNAME=$UBUNTU_REPO_IP/g" local.conf
