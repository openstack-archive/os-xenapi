...
function config_ovs_agent {
    ...
    # Configure q-domua, set host as Dom0's hostname
    iniset $NEUTRON_CORE_PLUGIN_CONF.domU DEFAULT host "$XS_DOM0_HOSTNAME"
...
function config_nova_compute {
    ...
    iniset $NOVA_CONF DEFAULT host "$XS_DOM0_HOSTNAME"
}
