...
DEV_STACK_DIR="$THIS_DIR/devstack"
...
{
cat >&2 << EOF
usage: $0 XENSERVER_PASS <optional arguments>
...
$DEV_STACK_DIR/install_devstack.sh $XENSERVER_PASS -d $DEVSTACK_SRC -l $LOGDIR
