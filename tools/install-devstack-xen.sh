...
optional arguments:
 ...
 -s SUPP_PACK_URL      URL to a supplemental pack that will be installed on the host
                       ...
                       picked up.
 -o OSXENAPI_SRC       An URL point to a zip file for os-xenapi, This defaults to the
...
scp $_SSH_OPTIONS -r $PRIVKEY $DEFAULT_INSTALL_SRC/* root@$XENSERVER:$DOM0_OPT_DIR
