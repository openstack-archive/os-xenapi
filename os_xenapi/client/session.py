...
class XenAPISession(object):
    ...
    ORIGINATOR_NOVA = "os-xenapi-nova"
    ...
    def __init__(self, url, user, pw, originator="os-xenapi", timeout=10,
        ...
        exception = XenAPI.Failure(_("Unable to log in to XenAPI "
        ...
        self._verify_plugin_version(originator)
    ...
    def _verify_plugin_version(self, originator):
        if originator != self.ORIGINATOR_NOVA:
            return
